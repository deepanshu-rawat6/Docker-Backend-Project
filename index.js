...
app.get("/api/v1", (req, res) => {
    res.send("<h2>Hello there, I'm Deepanshu, trying to build this node-docker-express app, using docker-compose and distributing the workflow into dev and prod env. This is for testing out the production server. Again testing out prod env. Now using watchower to automatically pull images to prod env. Trying out Docker Swarm for container orchrestration</h2>");
